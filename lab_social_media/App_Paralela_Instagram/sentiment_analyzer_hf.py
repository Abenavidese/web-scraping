# -*- coding: utf-8 -*-
"""
Instagram Sentiment Analyzer using DeepSeek API
Migrated from Hugging Face to centralized DeepSeek
"""
...
def main_sentiment_analysis_instagram(input_csv='Resultados/sentiment_input.csv',
                                      ...
                                      api_key=None):
    """
    Análisis de sentimientos para Instagram con DeepSeek API.
